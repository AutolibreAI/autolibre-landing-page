...
const DESCRIPTION = "Términos y condiciones de uso del servicio AutoLibre.";
const PATH = "/terminos";
  ...
  return (
    <>
      <LegalPage title={TITLE} updatedAt="junio 2026">
        <h2>1. Aceptación</h2>
        <p>
          Al acceder a este sitio web o registrarte en la lista de Early Access
          de AutoLibre, aceptás estos Términos y Condiciones en su totalidad.
        </p>
        ...
        <p>
          ...
          asistidos por inteligencia artificial y gestionar trámites
          automotrices. El servicio está actualmente en etapa de Early Access.
        </p>
